# -*- coding: utf-8 -*-
"""
COVID-19 Modeling with initial basic model and evolutionary algorithm (without GUI)

Github link: https://github.com/abhishikasharma/Covid-19Simulation
...
i=0
#Empty lists for storing the parameters values for the# population of Norway    
...
fitness_score = [[1],[2],[3],[4],[5],[6]] #selected parents
parent1 = []
parent2 = []
new_parent1 = []
new_parent2 = []
